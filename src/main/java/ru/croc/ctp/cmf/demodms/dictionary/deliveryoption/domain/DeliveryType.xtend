...
@Table(name=DeliveryType.TABLE_NAME)
@EntityListeners(AuditingEntityListener)
class DeliveryType implements SupportSystemNameDictionaryItem, Editable, CmfDictionary {

    /**
     * Наименование таблицы хранения.
     */
    public static final String TABLE_NAME = "cmf_deliverytype"
