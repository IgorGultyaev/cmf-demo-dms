package ru.croc.ctp.cmf.sedproject.document.warrant.regnumber;
...
/**
 * Компонент, выбирающий для переданного placeholder'а необходимый PlaceholderEvaluator.
 */
@Component
public class WarrantPlaceholderResolver extends AbstractPlaceholderResolver {
